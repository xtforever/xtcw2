 ...
 */
#ifndef XTCW_VSLIDER_H
#define XTCW_VSLIDER_H
#include <X11/Core.h>
_XFUNCPROTOBEGIN
#include "mls.h"
...
typedef struct _VSliderClassRec *VSliderWidgetClass;
typedef struct _VSliderRec *VSliderWidget;
externalref WidgetClass vSliderWidgetClass;
_XFUNCPROTOEND
#endif /* XTCW_VSLIDER_H */
