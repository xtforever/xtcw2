\input wbuildmac.tex
\Class{VBox}This widget puts the child widgets from left to right in a box.
...
\Publicvars
\Table{VBox}
XtNvgap&XtCVgap&Distance &"2mm"\cr
\endTable
\Section
\Publicvar{XtNvgap}
...
Distance  vgap = {\langle}String{\rangle}"2mm"
...
{\lbrace}
    ...
    {\dollar}total{\underline}width = max{\underline}w;
    {\dollar}total{\underline}height = ({\dollar}num{\underline}children - 1) * {\dollar}vgap + max{\underline}h * {\dollar}num{\underline}children;

    TRACE(2,"{\percent}s: {\percent}s {\percent}dx{\percent}d gap={\percent}d{\backslash}n",{\underline}{\underline}func{\underline}{\underline}, {\dollar}name, {\dollar}total{\underline}width, {\dollar}total{\underline}height, {\dollar}vgap );
{\rbrace}\endCode
...
{\lbrace}
    ...
    height =  {\dollar}height - ({\dollar}num{\underline}children - 1) * {\dollar}vgap;
    height /= {\dollar}num{\underline}children;

    if(DB) printf("{\percent}s: {\percent}s child size: {\percent}f {\percent}u{\backslash}n", XtName({\dollar}), {\underline}{\underline}func{\underline}{\underline}, {\dollar}width, height);

    y=0;
    for (i = 0; i {\langle} {\dollar}num{\underline}children; i++) {\lbrace}
        child = {\dollar}children[i];
        b={\dollar}child{\dollar}border{\underline}width;
        XtConfigureWidget(child, 0, y, {\dollar}width - 2 *b,
                          height - 2*b, b );
        y += height + {\dollar}vgap;
    {\rbrace}
{\rbrace}\endCode
