...
\Section
\Code
void  karoEd{\underline}writeln(Widget  w, char * s)\endCode
{\lbrace}
  KaroEdWidgetClass wc = (KaroEdWidgetClass)XtClass(w);
   /*  if( XtIsSubclass( w, karoEdWidgetClass) {\ampersand}{\ampersand} wc-{\rangle}karoEd{\underline}class.writeln )
    {\lbrace}
      wc-{\rangle}karoEd{\underline}class.writeln(w,s);
    {\rbrace}
    */
{\rbrace}
